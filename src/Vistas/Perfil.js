                ...
                <div className="area_p">
                    ...
                    <div className="info_form">
                        <div className="opcion-block">
                            ...
                            <select id="tipo_doc" className="inputs_info add_input" name="tipo_doc" style={{width : "270px"}}>
                        ...
                        <div className="opcion-block">
                            ...
                            <input type="text" id="iden" className="inputs_info add_input" name="iden" value="1027290782"/>
                        </div>
                        <div className="opcion-block">
                        ...
                        <div className="opcion-block">
                            ...
                            <input type="date" id="date_nacimiento" className="inputs_info add_input" name="date_nacimiento" value="2004/08/19"/>
                        </div>
                    </div>
                </div>
            </div>
