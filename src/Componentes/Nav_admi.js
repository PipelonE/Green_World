...
export const Navadmi = () => {
    ...
    return (
        <header className="cabecera" id="cabecera" ref={refheader} style={{backgroundColor: background}}>
            ...
            <ul class="menu">
                <li className="item"><a href="/estadisticas"><Link to="/estadisticas">Estadistica</Link></a></li>
                <li className="item"><a href="/admiproductos"><Link to="/admiproductos">Productos</Link></a></li>
                <li className="item"><a href="/roles"><Link to="/roles">Roles</Link></a></li>
